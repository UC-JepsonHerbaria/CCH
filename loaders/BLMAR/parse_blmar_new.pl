...
open(OUT,">BLMAR_out.txt") || die;
open(OUT2,">BLMAR_dwc.txt") || die;
...
%seen=();
    ...
    my $file_out = 'BLMAR_out.txt';	#the file this script will act upon is called 'BLMAR.out'
